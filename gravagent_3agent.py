...
"""
    ...
    def execute_integrated_script(self, integration_result: Dict, execution_dir: str = None) -> Dict:
        """Execute the integrated script and capture results"""
        ...
        try:
            ...
            # Rest of your existing execution code remains the same...
            # Execute the script
...
Total tokens used: {self.scientific_interpreter.total_tokens_used + getattr(self.data_analyst, 'total_tokens_used', 0) + self.executor.total_tokens_used}
"""
def main():
