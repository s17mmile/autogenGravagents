...
[Brief explanation of the fixes applied and why they should work]"""
    ...
    def analyze_and_fix_error(self, failed_code: str, error_message: str, 
        ...
        """Simplified but more effective debugging"""
        ...
        print(f"[DEBUGGER] Core error: {core_error}")
        print(f"[DEBUGGER] Attempt #{attempt_count + 1}")
        
        # Generate fix with better context
        fix_result = self._generate_smart_fix(failed_code, core_error, attempt_count, available_packages, debug_history)
