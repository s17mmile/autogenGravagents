# filename: gw150914_analysis_final_corrected_v4.py
import os
import numpy as np
...
def save_q_transform_plot(q_data, title, filename):
    try:
        ...
        plt.imshow(q_data, aspect='auto', origin='lower', cmap='inferno', interpolation='none')
...
try:
    q_h1 = h1_filtered.q_transform()
    q_l1 = l1_filtered.q_transform()
except Exception as e:
