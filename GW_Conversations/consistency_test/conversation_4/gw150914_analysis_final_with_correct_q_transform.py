# filename: gw150914_analysis_final_with_correct_q_transform.py
...
from gwpy.signal.qtransform import q_transform
...
if h1_filtered is not None and l1_filtered is not None:
    try:
        h1_q_transform = q_transform(h1_filtered, dt=1.0/4096, fmin=30, fmax=250)
        l1_q_transform = q_transform(l1_filtered, dt=1.0/4096, fmin=30, fmax=250)
...
for mass in masses:
    try:
        template = waveform.get_td_waveform(approximant=approximant, mass1=mass, mass2=mass, spin1z=0, spin2z=0)
