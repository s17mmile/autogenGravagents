# filename: gw150914_analysis_final_with_correct_q_transform_and_psd_fixed.py
...
h1_psd = h1_pycbc.psd(segment_duration=segment_duration, method='welch')
l1_psd = l1_pycbc.psd(segment_duration=segment_duration, method='welch')
