# filename: gw150914_analysis_final_v4.py
import os
import numpy as np
import matplotlib.pyplot as plt
from gwpy.timeseries import TimeSeries
from gwosc.datasets import event_gps
from pycbc import waveform, filter as pycbc_filter
...
plt.figure(figsize=(10, 5))
plt.imshow(h1_q_transform, aspect='auto', origin='lower', extent=[h1_q_transform.times[0], h1_q_transform.times[-1], 0, 25], cmap='inferno')
...
plt.figure(figsize=(10, 5))
plt.imshow(l1_q_transform, aspect='auto', origin='lower', extent=[l1_q_transform.times[0], l1_q_transform.times[-1], 0, 25], cmap='inferno')
plt.colorbar(label='Normalized Energy')
...
try:
    h1_psd = h1_filtered.psd()
    l1_psd = l1_filtered.psd()
except Exception as e:
