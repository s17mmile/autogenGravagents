...
# Using the Q-transform method from GWpy TimeSeries
try:
    dt = h1_filtered.dt  # Time step of the data
    q_transform_h1 = h1_filtered.q_transform(dt=dt, fmin=30, fmax=250)
    q_transform_l1 = l1_filtered.q_transform(dt=dt, fmin=30, fmax=250)
    plt.figure(figsize=(12, 6))
...
try:
    h1_pycbc = PyCBC_TimeSeries(h1_data, dt=h1_data.dt)
    l1_pycbc = PyCBC_TimeSeries(l1_data, dt=l1_data.dt)
