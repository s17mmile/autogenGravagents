# filename: gw150914_analysis_fixed.py
...
# Using a dedicated Q-transform function
plt.figure(figsize=(12, 6))
...
try:
    h1_pycbc = filter.TimeSeries(h1_data, delta_t=h1_data.delta_t)
    l1_pycbc = filter.TimeSeries(l1_data, delta_t=l1_data.delta_t)
