# filename: gw150914_analysis_final_v14.py

import os
import numpy as np
import matplotlib.pyplot as plt
from gwpy.timeseries import TimeSeries
from gwpy.transform import qtransform
...
def q_transform(h1_filtered, l1_filtered):
    ...
    dt_h1 = h1_filtered.delta_t
    dt_l1 = l1_filtered.delta_t

    q_h1 = qtransform(h1_filtered, dt=dt_h1, fmin=30, fmax=250)
    q_l1 = qtransform(l1_filtered, dt=dt_l1, fmin=30, fmax=250)

    plt.figure(figsize=(12, 6))
    plt.imshow(q_h1, aspect='auto', origin='lower', extent=[h1_filtered.times[0], h1_filtered.times[-1], 30, 250], cmap='inferno')
    ...
    plt.figure(figsize=(12, 6))
    plt.imshow(q_l1, aspect='auto', origin='lower', extent=[l1_filtered.times[0], l1_filtered.times[-1], 30, 250], cmap='inferno')
    plt.colorbar(label='Energy')
