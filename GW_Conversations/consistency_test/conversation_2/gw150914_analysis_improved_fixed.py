# filename: gw150914_analysis_improved_fixed.py
...
def convert_to_pycbc(h1_filtered, l1_filtered):
    ...
    h1_pycbc = pycbc_types.TimeSeries(h1_filtered, delta_t=h1_filtered.delta_t)
    l1_pycbc = pycbc_types.TimeSeries(l1_filtered, delta_t=l1_filtered.delta_t)
