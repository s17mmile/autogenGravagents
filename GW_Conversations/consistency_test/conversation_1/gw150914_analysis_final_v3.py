# filename: gw150914_analysis_final_v3.py
...
try:
    ...
    for mass in masses:
        ...
        template = waveform.get_fd_waveform(approximant='IMRPhenomD', mass1=mass, mass2=mass, spin1z=0, spin2z=0, f_lower=20, delta_f=1.0)
