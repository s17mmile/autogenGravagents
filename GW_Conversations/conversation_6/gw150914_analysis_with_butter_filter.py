# filename: gw150914_analysis_with_butter_filter.py
import os
import numpy as np
from gwpy.timeseries import TimeSeries
from gwpy.plot import Plot
from pycbc.filter import butter
...
try:
    ...
    # Apply band-pass filter using butter function
    h1_filtered = butter(h1_whitened, 30, 250, h1_whitened.sample_rate)
    l1_filtered = butter(l1_whitened, 30, 250, l1_whitened.sample_rate)
