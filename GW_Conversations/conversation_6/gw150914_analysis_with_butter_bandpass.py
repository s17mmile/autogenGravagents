# filename: gw150914_analysis_with_butter_bandpass.py
import os
import numpy as np
from gwpy.timeseries import TimeSeries
from gwpy.plot import Plot
from pycbc.filter import butter_bandpass, lfilter
...
try:
    ...
    # Apply band-pass filter using butter_bandpass function
    h1_butter_coeffs = butter_bandpass(30, 250, h1_whitened.sample_rate)
    h1_filtered = lfilter(h1_butter_coeffs, 1.0, h1_whitened)
    l1_butter_coeffs = butter_bandpass(30, 250, l1_whitened.sample_rate)
    l1_filtered = lfilter(l1_butter_coeffs, 1.0, l1_whitened)
