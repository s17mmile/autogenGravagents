...
from pycbc.waveform.bank import generate_bank
...
try:
    ...
    bank = generate_bank(**bank_params)
...
for i, template in enumerate(bank):
    try:
        # Generate frequency-domain waveform for this template
...
try:
    ...
    distance = best_template.get('distance', 1000.0)  # Mpc
