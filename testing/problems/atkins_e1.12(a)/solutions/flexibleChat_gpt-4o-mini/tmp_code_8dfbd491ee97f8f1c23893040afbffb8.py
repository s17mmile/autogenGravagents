...
plt.scatter(densities, temperatures_k, color='blue', label='Data Points')
plt.plot(densities, model.predict(X), color='red', label='Regression Line')
plt.xlabel('Density (g/dm³)')
