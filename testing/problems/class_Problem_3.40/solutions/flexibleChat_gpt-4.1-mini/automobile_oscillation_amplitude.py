# filename: automobile_oscillation_amplitude.py
import math
...
delta_y_max = 2 * road_amplitude * abs(math.sin(arg))
...
print(f"Driving displacement amplitude delta_y_max: {delta_y_max:.5f} m")
