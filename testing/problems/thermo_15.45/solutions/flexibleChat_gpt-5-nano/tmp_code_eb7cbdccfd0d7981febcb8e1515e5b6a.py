...
def G_deg_T(T=298.15, nu_tilde=560.0, B_cm=0.244, M_g_per_mol=69.937,
    ...
    This function returns a dictionary with the decomposition and final G°(T).

    Parameters:
    - T: Temperature in Kelvin
    - nu_tilde: Vibrational wavenumber in cm^-1
    ...
    - sigma: Rotational symmetry number (default 2)
    - spin_statistics: If True and weights_J provided, use weighted rotor over J
    - weights_J: Sequence of weights w_J for J = 0..J_max (non-negative). If None, uses high-T rotor
    - J_max: Maximum J included when weights_J is provided
    """
    # Derived quantities
    ...
    # Vibrational contribution (harmonic oscillator, correct form)
...
if __name__ == "__main__":
    ...
    print("G°(298.15 K) =", G_298/1000.0, "kJ/mol")
