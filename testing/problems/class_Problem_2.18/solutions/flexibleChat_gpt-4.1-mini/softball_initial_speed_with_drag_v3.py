# filename: softball_initial_speed_with_drag_v3.py
import numpy as np
...
def pass_fence(t, y, fence_distance, *args):
...
def clears_fence(initial_speed, angle_deg, fence_distance, fence_height, params):
    ...
    sol = solve_ivp(
        ...
        y0,
        args=(params,),
        events=[hit_ground, lambda t, y, *args: pass_fence(t, y, fence_distance, *args)],
        dense_output=True,
        max_step=0.01
    )
