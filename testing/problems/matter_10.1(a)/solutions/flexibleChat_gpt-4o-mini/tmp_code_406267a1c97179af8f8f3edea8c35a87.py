...
# Normalize the wave function using a simple numerical integration method
normalization_factor = np.sum(psi**2) * (x[1] - x[0])  # Simple Riemann sum
psi /= np.sqrt(normalization_factor)
