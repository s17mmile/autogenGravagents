# filename: neutron_final_speed_fixed.py
import math
...
initial_guess = [u_initial * 0.9, u_initial * 0.9]
...
if valid_pos and valid_neg:
    ...
    if abs(v_n_pos - u_initial) < abs(v_n_neg - u_initial):
...
with open('final_collision_results.txt', 'w') as f:
    f.write(f'Initial deuteron speed: {u_initial:.4f} km/s\n')
