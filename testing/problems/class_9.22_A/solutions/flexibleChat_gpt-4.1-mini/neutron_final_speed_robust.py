# filename: neutron_final_speed_robust.py
import math
...
initial_guesses = [
    [nu_initial * 0.9, nu_initial * 0.9],
    [nu_initial * 0.5, nu_initial * 1.0],
    [nu_initial * 1.0, nu_initial * 0.5],
    [nu_initial * 1.1, nu_initial * 1.1]
]
...
# Output results
output = (
    f'Initial deuteron speed: {nu_initial:.4f} km/s\n'
