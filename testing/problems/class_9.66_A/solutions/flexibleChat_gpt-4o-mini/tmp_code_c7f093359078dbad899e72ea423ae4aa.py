...
mass_flow_rate = propellant_mass / burn_time  # Mass flow rate in kg/s

# Calculate average velocity using thrust and drag
# Initial conditions
...
for step in range(num_steps):
    ...
    mass -= mass_flow_rate * dt  # Update mass

# Final velocity after burn time
v_final = v
